-- ============================================================================
-- FIX: Picker Save Issue - Missing picked_quantity column
...
-- ============================================================================
-- PART 2: UPDATE EXISTING RECORDS WITH DEFAULT VALUES
-- ============================================================================
...
SET 
    ...
    priority = COALESCE(priority::integer, 1),
    updated_at = NOW()
...
-- Test inserting sample picking data
SELECT 'Testing sample picking data:' as info;
SELECT 
    obsd.id,
