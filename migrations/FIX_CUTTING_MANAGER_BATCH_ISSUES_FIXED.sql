-- ============================================================================
-- FIX: Cutting Manager Batch Images and Quantity Issues (Type-Safe Version)
-- Generated: October 8, 2025
-- Description: Fix batch images not showing and quantities showing 0 (with type fixes)
-- ============================================================================
...
-- ============================================================================
-- PART 7: RECREATE ORDER_BATCH_ASSIGNMENTS_WITH_DETAILS VIEW (TYPE-SAFE)
-- ============================================================================
...
SELECT 
    ...
    -- Size distributions (aggregated) - TYPE-SAFE VERSION
    COALESCE(
        json_agg(
            json_build_object(
