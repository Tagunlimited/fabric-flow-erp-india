-- Fix RLS policies for invoices table to allow INSERT operations
...
DROP POLICY IF EXISTS "Customers can insert own invoices with permission" ON public.invoices;
DROP POLICY IF EXISTS "Customers can update own invoices with permission" ON public.invoices;
DROP POLICY IF EXISTS "Customers can delete own invoices with permission" ON public.invoices;
