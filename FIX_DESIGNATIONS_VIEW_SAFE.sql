-- ============================================================================
-- FIX: Create designations_with_departments view (Safe Version)
-- Generated: October 8, 2025
-- Description: Creates the missing designations_with_departments view with proper column handling
-- ============================================================================
...
-- ============================================================================
-- PART 6: CREATE THE DESIGNATIONS_WITH_DEPARTMENTS VIEW (SAFE VERSION)
-- ============================================================================

-- Drop the view if it exists
DROP VIEW IF EXISTS designations_with_departments;

-- Create the view with proper column handling
-- This version handles different possible column names in departments table
