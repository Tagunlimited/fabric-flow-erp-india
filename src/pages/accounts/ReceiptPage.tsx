...
export default function ReceiptPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // But we'll also generate a fallback timestamp-based number as backup
      console.log('Receipt number will be auto-generated by database...');
      
      // Generate fallback receipt number using timestamp to ensure uniqueness
      const timestamp = Date.now();
      const fallbackReceiptNumber = `RCP/FB/${timestamp}`;

      // Create receipt
      const payload = {
        receipt_number: fallbackReceiptNumber, // Fallback number in case trigger fails
