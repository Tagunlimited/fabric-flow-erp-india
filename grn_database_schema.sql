-- Goods Receipt Note (GRN) Database Schema
-- Run this in your Supabase SQL Editor

-- 1. Create grn_master table (Header)
...
-- 2. Create grn_items table (Line Items)
...
-- 3. Create grn_quality_inspections table (Detailed Quality Control)
...
-- 4. Create grn_discrepancies table (Track discrepancies)
...
-- 5. Create grn_attachments table (Supporting documents)
...
-- 9. Create function to generate GRN number
...
-- 10. Create function to update GRN totals
...
-- 11. Create trigger to auto-update GRN totals when items change
...
-- 15. Success message
SELECT 'GRN database schema created successfully!' as status;
